...
//  console.log('Setup settings');
  ...
  if(Users.find().count() === 0) {
    ...
    makeTag({name: 'Tag 1', slug: 'tag_1', description: '', auth: key });
    makeTag({name: 'Tag 2', slug: 'tag_2', description: '', auth: key });
    makeTag({name: 'Tag 3', slug: 'tag_3', description: '', auth: key });
    console.log(Tags.find().count()+' tags added');
    
    tags = Tags.find({}, {fields: {_id:1} });
    ...
    tagsPost1 = [ tagArray[0] ];
    tagsPost2 = [ tagArray[1] ];
    tagsPost3 = [ tagArray[0], tagArray[2]];
